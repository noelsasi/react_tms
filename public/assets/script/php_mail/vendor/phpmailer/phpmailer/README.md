...
try {
    ...
    $mail->Host       = 'smtp.scholarvault.com';                     //Set the SMTP server to send through
    $mail->SMTPAuth   = true;                                   //Enable SMTP authentication
    $mail->Username   = 'user@scholarvault.com';                     //SMTP username
    $mail->Password   = 'secret';                               //SMTP password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
    $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

    //Recipients
    $mail->setFrom('from@scholarvault.com', 'Mailer');
    $mail->addAddress('joe@example.net', 'Joe User');     //Add a recipient
    $mail->addAddress('ellen@scholarvault.com');               //Name is optional
    $mail->addReplyTo('info@scholarvault.com', 'Information');
    $mail->addCC('cc@scholarvault.com');
    $mail->addBCC('bcc@scholarvault.com');
